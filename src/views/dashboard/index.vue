      ...
      <div>
        <div class="fl headL">
          ...
          <div class="headInfoTip">
            <p class="firstChild">早安，{{ name }}，祝你开心每一天！{{ $t('message') }}</p>
            <p class="lastChild">{{ companyName }}，祝你开心每一天！</p>
          </div>
        </div>
        <div class="fr" />
      </div>
...
import WorkCalendar from '@/views/dashboard/components/work-calender'
